...
var flush, head, last, notify$5, toggle, node, promise, then;
...
var notify$4 = function (state, isReject) {
...
if (FORCED$3) {
  ...
  Internal.prototype = redefineAll(PromiseConstructor.prototype, {
    ...
    then: function then(onFulfilled, onRejected) {
      ...
      if (state.state != PENDING) notify$4(state, false);
...
add('ru', {
  admin: {
    eventlog: {
      versionCounts: 'Глубина хранения (записей)',
      shelfLife: 'Срок хранения (месяцев)',
...
var View = /*#__PURE__*/function (_Component) {
  ...
  _createClass(View, [{
    key: "render",
    value: function render(element, _ref) {
      var _this = this;
